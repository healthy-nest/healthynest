  ...
  return (
    <footer className="bg-white text-gray-800 pt-16 px-6 md:px-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pb-12">
        <div>
          <h3 className="text-xl font-bold mb-4 text-primary">HealthyNest</h3>
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-primary-700">Quick Links</h4>
          <ul className="space-y-2 text-sm text-gray-600">
            <li><a href="#" className="hover:text-primary-600">Home</a></li>
            <li><a href="#" className="hover:text-primary-600">About</a></li>
            <li><a href="#" className="hover:text-primary-600">Services</a></li>
            <li><a href="#" className="hover:text-primary-600">Contact</a></li>
          </ul>
        </div>

        <div>
          <h4 className="text-lg font-semibold mb-4 text-primary-700">Support</h4>
          <ul className="space-y-2 text-sm text-gray-600">
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-primary-700">Contact</h4>
          <ul className="space-y-2 text-sm text-gray-600">
